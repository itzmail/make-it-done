...
When text contains `question`, it should convert to `question`.
...
- `~/.config/opencode/makeitdone/` → `~/.config/opencode/makeitdone/`
- `$HOME/.config/opencode/makeitdone/` → `$HOME/.config/opencode/makeitdone/`
